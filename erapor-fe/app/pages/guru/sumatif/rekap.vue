  ...
  <div class="h-full flex flex-col min-h-0 bg-slate-50">
    ...
    <div class="flex-1 flex flex-col xl:flex-row overflow-hidden relative">
      ...
      <div class="flex-1 bg-slate-50 flex flex-col h-full min-w-0 relative transition-all pt-[60px] xl:pt-0 print:bg-white print:block print:h-auto print:overflow-visible print:pt-0" :class="activeTabMobile === 'flow' ? 'flex' : 'hidden xl:flex'">
        <div class="p-2 lg:p-6 max-w-6xl mx-auto w-full h-full flex flex-col relative z-0 print:p-0 print:max-w-none print:block print:h-auto print:overflow-visible">
