      ...
      <div class="flex-1 bg-white flex flex-col h-full min-w-0 relative transition-all pt-[60px] xl:pt-0" :class="activeTabMobile === 'flow' ? 'flex' : 'hidden xl:flex'">
          <div class="flex flex-col flex-1 relative min-h-0">
            ...
            <div v-else class="flex-grow flex flex-col relative bg-slate-50/30 overflow-hidden">
              ...
              <div class="flex-1 overflow-auto custom-scrollbar relative pb-10 bg-white">
                <table class="w-full text-left border-collapse bg-white table-fixed">
                  <thead class="sticky top-0 z-20 shadow-sm">
                    <!-- Header Grouping -->
                    <tr class="bg-slate-200 border-b border-slate-300">
                      <th rowspan="2" class="hidden md:table-cell py-3 px-4 text-[10px] font-black uppercase tracking-widest text-slate-500 sticky left-0 bg-slate-100 z-30 w-[180px] sm:w-[250px] border-r border-slate-300 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.05)] align-middle">
                        Nama Siswa
                      </th>
                  ...
                  <tbody class="divide-y divide-slate-100">
                    <template v-for="siswa in siswas" :key="siswa.id">
                      ...
                      <!-- Inputs Row (Desktop Name + Inputs) -->
                      <tr class="hover:bg-sky-50/20 group transition-colors h-12 border-b-2 border-slate-200 md:border-b-0">
                        <!-- Desktop Name Cell -->
