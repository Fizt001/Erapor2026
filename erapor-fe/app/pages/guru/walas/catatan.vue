        ...
        <div class="p-4 pb-2 space-y-4">
          <div class="bg-gradient-to-r from-amber-600 to-amber-700 rounded-2xl p-4 border border-amber-500 shadow-sm relative overflow-hidden flex items-center gap-3">
            ...
            <div class="relative z-10">
              <h3 class="text-xs font-black uppercase tracking-widest text-white">Catatan Wali Kelas</h3>
              <p class="text-[10px] text-amber-100 font-semibold uppercase mt-0.5">Catatan Walas Per Rombel</p>
            </div>
            <div class="absolute right-0 bottom-0 opacity-15 text-white pointer-events-none">
              <svg class="w-16 h-16 transform translate-x-6 translate-y-6" fill="currentColor" viewBox="0 0 24 24"><path d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
            </div>
          </div>
