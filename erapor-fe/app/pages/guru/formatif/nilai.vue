        ...
        <div class="p-4 pb-2 space-y-4">
          <div class="bg-gradient-to-r from-sky-600 to-blue-700 rounded-2xl p-4 border border-sky-500 shadow-sm relative overflow-hidden flex items-center gap-3">
            ...
            <div class="relative z-10">
              ...
              <p class="text-[10px] text-sky-100 font-semibold uppercase mt-0.5">Asessmen Formatif</p>
            </div>
          ...
          <div class="bg-white rounded-none lg:rounded-3xl shadow-sm border border-slate-200/60 overflow-hidden flex flex-col flex-1 relative min-h-0">
            ...
            <div class="px-4 py-3 border-b border-slate-200 flex justify-between items-center bg-white shrink-0 z-10">
              <div class="flex items-center gap-3">
                <div class="w-10 h-10 bg-sky-50 text-sky-600 rounded-xl flex items-center justify-center border border-sky-100"><AppIcon name="clipboard-document-list" class="w-5 h-5" /></div>
                <div>
                  <h3 class="text-[13px] font-black leading-none uppercase tracking-wide text-slate-800 flex items-center gap-2">
                    Matriks Nilai Formatif
            ...
            <div v-if="!isFilterComplete" class="flex-grow flex flex-col items-center justify-center p-16 text-center relative overflow-hidden bg-slate-50/50">
              <div class="w-24 h-24 mb-6 rounded-full bg-sky-50 flex items-center justify-center border-8 border-white shadow-sm relative z-10">
                  <div class="animate-bounce-slow text-sky-400 flex justify-center"><AppIcon name="document-text" class="w-10 h-10" /></div>
              </div>
            ...
            <div v-else-if="!references.is_titimangsa_aktif" class="flex-grow flex items-center justify-center flex-col p-16 text-center bg-slate-50/50">
              <div class="mb-6 text-slate-400 flex justify-center"><AppIcon name="lock-closed" class="w-16 h-16" /></div>
