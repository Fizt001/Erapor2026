...
export const kurikulumMenus: MenuConfig[] = [
  ...
  { name: 'Plot Guru Mapel', path: '/kurikulum/pengampu', icon: 'users-group' },
  { name: 'Wali Kelas', path: '/kurikulum/wali-kelas', icon: 'users' },
  { name: 'Jadwal Mengajar', path: '/kurikulum/jadwal', icon: 'calendar-event' },
